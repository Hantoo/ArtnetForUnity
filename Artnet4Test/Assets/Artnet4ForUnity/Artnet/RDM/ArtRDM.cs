...
namespace ArtnetForUnity.RDM
{
    ...
    public class ArtRDM : MonoBehaviour
    {
        ...
        byte[] pkt_Spare = new byte[7];  //Offset 13 
        byte[] pkt_Net = new byte[1];  //Offset 13 
        byte[] pkt_Command = new byte[1];  //Offset 13 
        byte[] pkt_Address = new byte[1];  //Offset 13 
        byte[] pkt_RdmPacket = new byte[1];  //Offset 13 
